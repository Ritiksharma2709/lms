...
<p className='text-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, pariatur?</p>
...
<div className='space-y-4'>
  <div>
<Label>Title</Label>
<Input type="text" name="lectureTitle" placeholder="your title name" value={lectureTitle} onChange={(e)=>setLectureTitle(e.target.value)} />
  </div>
